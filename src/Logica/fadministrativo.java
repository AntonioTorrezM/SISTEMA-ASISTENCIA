...
public class fadministrativo {
    ...
    public DefaultTableModel mostrar(String buscar){
        ...
        String [] titulos={"ID","Idcargo","Cargo","Nombres","Apellidos","CI","Telefono","Direccion","Email","Sexo","Fecha_Ingreso"};
        String [] registros=new String [11];
        totalregistros=0;
        modelo=new DefaultTableModel(null,titulos);
        sSQL="select  ad.idadministrativo,ad.idcargo, ca.descripcion, ad.nombres, ad.apellidos,ad.CI,ad.telefono,ad.direccion,ad.email,ad.sexo,ad.fecha_ingreso from administrativo ad inner join cargo ca on ad.idcargo=ca.idcargo  where ad.CI like '%"+ buscar +"%' order by idadministrativo desc ";
    ...
    public DefaultTableModel mostrarvistaadminnistrativo(String buscar){
     ...
     public  boolean insertar(vadministrativo dts){
        sSQL= "insert into administrativo (idcargo,nombres,apellidos,CI,telefono,direccion,email,sexo,fecha_ingreso)" +
        "values (?,?,?,?,?,?,?,?,?)";
        try {
      ...
      public  boolean editar(vadministrativo dts){
        sSQL= "update  administrativo set  idcargo=?,nombres=?,apellidos=?,CI=?,telefono=?,direccion=?,email=?,sexo=?,fecha_ingreso=?" +
