...
public class frmreportasis_docentes extends javax.swing.JInternalFrame {
    private Connection cn;

    /**
     * Creates new form frmreportasis_docentes
     */
    public frmreportasis_docentes() {
        initComponents();
        mostrar("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmreportasis_docentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmreportasis_docentes().setVisible(true);
            }
        });
    }
