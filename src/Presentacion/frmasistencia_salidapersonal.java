...
import Logica.fasistenciadocentes;
...
public class frmasistencia_salidapersonal extends javax.swing.JInternalFrame {

    /**
     * Creates new form frmasistencia_personal
     */
    public frmasistencia_salidapersonal() {
        initComponents();
         mostrar("");
        inhabilitar();
    }
 private String accion = "guardar";
     ...
     void habilitar() {
      ...
      void mostrar(String buscar) {
        try {
            ...
            fasistenciadocentes func = new fasistenciadocentes();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ASISTENCIA SALIDA DOCENTES");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Registro de Licencia", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Agency FB", 1, 14), new java.awt.Color(0, 0, 102))); // NOI18N
        ...
        lblhoraingreso.setBackground(new java.awt.Color(255, 0, 0));
        lblhoraingreso.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblhoraingreso.setText("Hora Ingreso:");

        lblhorasalida.setBackground(new java.awt.Color(255, 255, 255));
        lblhorasalida.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblhoraingreso, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblhorasalida, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
...
txthora_salida.setText(hora);
        ...
        vasistenciadocentes dts = new vasistenciadocentes();
        fasistenciadocentes func = new fasistenciadocentes();
        ...
        if (accion.equals("guardar")) {
            ...
            dts.setIdasistencia_docentes(Integer.parseInt(txtasistencia.getText()));
    ...
    private void btnbuscaradministrativoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscaradministrativoActionPerformed
        // TODO add your handling code here:
        frmvista_ingresodocentes form=new frmvista_ingresodocentes();
        form.toFront();
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        txtfecha.setText(tablalistado.getValueAt(fila, 4).toString());
        txthora_ingreso.setText(tablalistado.getValueAt(fila, 5).toString());
        txthora_salida.setText(tablalistado.getValueAt(fila, 6).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmasistencia_salidapersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmasistencia_salidapersonal().setVisible(true);
            }
        });
    }
