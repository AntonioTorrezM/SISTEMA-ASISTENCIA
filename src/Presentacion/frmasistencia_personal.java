...
import static Presentacion.frmasistencia_alumnos.txtapellidos;
import static Presentacion.frmasistencia_alumnos.txtfecha;
import static Presentacion.frmasistencia_alumnos.txtgrado;
import static Presentacion.frmasistencia_alumnos.txtidalumno;
import static Presentacion.frmasistencia_alumnos.txtnombres;
import static Presentacion.frmasistencia_alumnos.txtseccion;
...
public class frmasistencia_personal extends javax.swing.JInternalFrame {

    /**
     * Creates new form frmasistencia_personal
     */
    public frmasistencia_personal() {
        initComponents();
         mostrar("");
        inhabilitar();
    }
 private String accion = "guardar";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ASISTENCIA INGRESO DOCENTES");
...
txthora_ingreso.setText(hora);
        ...
        if (accion.equals("guardar")) {
            if (func.insertar(dts)) {
                JOptionPane.showConfirmDialog(rootPane, "Ingreso fue registrado satisfactoriamente");
                mostrar("");
                inhabilitar();
            }
            ...
            if (func.editar(dts)) {
                JOptionPane.showConfirmDialog(rootPane, "Ingreso fue registrada satisfactoriamente");
                mostrar("");
                inhabilitar();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmasistencia_personal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmasistencia_personal().setVisible(true);
            }
        });
    }
