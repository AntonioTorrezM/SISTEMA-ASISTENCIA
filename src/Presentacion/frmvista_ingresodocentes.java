 ...
 * @author ESCOBAR
 */
public class frmvista_ingresodocentes extends javax.swing.JFrame {

    /**
     * Creates new form frmvista_ingresodocentes
     */
    public frmvista_ingresodocentes() {
        initComponents();
         mostrar("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvista_ingresodocentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvista_ingresodocentes().setVisible(true);
            }
        });
    }
